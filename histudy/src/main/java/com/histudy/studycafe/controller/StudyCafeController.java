...
public class StudyCafeController {
	...
	@PostMapping
	public StudycafeJoinReservationDTO seatInfo(@RequestBody StudycafeJoinReservationDTO sjrdto) {

		StudycafeJoinReservationDTO info = studycafeService.seatInfo(sjrdto.getSeat_idx());
		return info;
	}
}
