	...
	<div id="signInFragment">
		...
		<form id="ajaxLoginForm">
			<div class="input-group">
				<input type="text" name="user_id" class="icon-id" placeholder="아이디">
			</div>
			<div class="input-group">
				<input type="password" name="user_pw" class="icon-pw"
					placeholder="비밀번호">
			</div>
			...
			<button type="button" class="login-submit-btn">로그인</button>
