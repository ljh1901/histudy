		...
		<div class="mypage-container">
			...
			<main class="mypage-main">
				<div id="profile-main-section">
					...
					<form id="profileForm"
						action="${pageContext.request.contextPath}/updateProfile.do"
									...
									<tr>
										...
										<td>
											<div id="intro-text" class="view-mode user-info-display"
												style="padding: 10px; line-height: 1.5;">${user.user_intro}</div>
											<textarea id="intro-input" class="edit-mode user-intro-edit"
												rows="5"
								...
								<div style="text-align: right; margin-top: 20px;">
									<div id="view-buttons">
										<button type="button" onclick="openPasswordChange()"
											style="background-color: #7B8188; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-weight: bold; margin-right: 5px;">비밀번호
											변경</button>
										<button type="button" onclick="toggleEditMode(true)"
											style="background-color: #4A90E2; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-weight: bold;">수정하기</button>
									</div>
									<div id="edit-buttons" style="display: none;">
										<button type="button" onclick="submitProfileUpdate()"
											style="background-color: #28a745; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-weight: bold; margin-right: 5px;">저장</button>
										<button type="button" onclick="toggleEditMode(false)"
											style="background-color: #6c757d; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-weight: bold;">취소</button>
									</div>
								</div>
							</div>
						</div>
